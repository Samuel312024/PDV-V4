...
var appDataRootPath = AppDataPathResolver.ResolveRootPath(builder.Environment, builder.Configuration);
var machineConfigRootPath = AppDataPathResolver.ResolveConfigRootPath(builder.Environment, builder.Configuration);
var uploadsRootPath = AppDataPathResolver.ResolveUploadsRootPath(builder.Environment, builder.Configuration);
var dataProtectionKeysRootPath = AppDataPathResolver.ResolveDataProtectionKeysRootPath(builder.Environment, builder.Configuration);
var downloadsRootPath = AppDataPathResolver.ResolveDownloadsRootPath(builder.Environment, builder.Configuration);
